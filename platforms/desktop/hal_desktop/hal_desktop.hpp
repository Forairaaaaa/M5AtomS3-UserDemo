...
public:
    ...
    void init() override
    {
        ...
        _data.config.wifiSsid     = "your_ssid";
        _data.config.wifiPassword = "your_password";
    ...
    OTA_UPGRADE::OtaInfo_t getLatestFirmwareInfoViaOta(OnLogPageRenderCallback_t onLogPageRender) override
    {
        ...
        info.firmwareUrl      = "www.fake_url.com";
    ...
    {
        static std::vector<NETWORK::WifiScanResult_t> ret = {{"fake_ssid_01", -20}, {"fake_ssid_02", -22},
                                                             {"fake_ssid_03", -44}, {"fake_ssid_04", -66},
                                                             {"fake_ssid_04", -77}, {"fake_ssid_05", -80}};
        return &ret;
    }

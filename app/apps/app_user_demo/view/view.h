...
#define LAYOUT_OFFSET_Y 30
    ...
    {
        const unsigned char* uart_mon_img_list[4] = {AssetPool::GetImage().AppUserDemo.uart_mon_01_img,
                                                     AssetPool::GetImage().AppUserDemo.uart_mon_02_img,
                                                     AssetPool::GetImage().AppUserDemo.uart_mon_03_img,
                                                     AssetPool::GetImage().AppUserDemo.uart_mon_04_img};
    ...
    {
        const unsigned char* pwm_img_list[4] = {AssetPool::GetImage().AppUserDemo.io_pwm_01_img,
                                                AssetPool::GetImage().AppUserDemo.io_pwm_02_img,
                                                AssetPool::GetImage().AppUserDemo.io_pwm_03_img,
                                                AssetPool::GetImage().AppUserDemo.io_pwm_04_img};
